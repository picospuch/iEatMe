...
bool HelloWorld::init()
{
    ...
    auto label = Label::createWithTTF("Hello EatMe", "fonts/Marker Felt.ttf", 48);
    
    CCActionInterval* actionTo = CCRotateTo::create(10, 36);
    ...
    auto sprite = Sprite::create("hungryfish9.png");
